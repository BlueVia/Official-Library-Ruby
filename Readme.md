...
- [OAuth](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_oauth.rb) : Demostrates OAuth process negotiation
- [SMS send](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_sms_mt.rb) : Sends SMS and a Check Delivery Status
- [SMS receive](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_sms_mo.rb) : Receive SMS.
- [MMS send](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_mms_mt.rb) : Sends MMS and a Check Delivery Status
- [MMS receive](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_mms_mo.rb) : Receive MMS
- [Payment](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_payment.rb) : Performs a Payment 
- [Location](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_location.rb) : Gets the location of a user
- [User Context](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_directory.rb) : Gets user access information
- [Advertising](https://github.com/BlueVia/Official-Library-Ruby/blob/master/src/samples/demo_advertising.rb) : Gets advertising
